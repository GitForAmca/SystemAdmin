<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeBehind="TaskSchedule.aspx.cs" Inherits="SystemAdmin.ESS.TaskSchedule" %>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <asp:Label ID="lblPageListTitle" runat="server" Text="Task Schedule"></asp:Label>
                </div>
            </div> 
                        ...
                        <asp:ListView ID="LV_Operation_Mapping" runat="server" ItemPlaceholderID="itemplaceholder">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <%# Eval("StartTime")%> To <%# Eval("EndTime")%>
                                    </td>
                                    <td>
            ...
            <div id="divAddEdit" runat="server" class="portlet-body form" visible="false">
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Task<span class="required" aria-required="true"> *</span></label>
                                <asp:DropDownList runat="server" ID="ddlTaskList" CssClass="form-control req select2ddl"></asp:DropDownList>
                            </div>
                        </div> 
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Start Time<span class="required" aria-required="true"> *</span></label>
                                <asp:TextBox ID="txtStartTime" class="form-control req" runat="server" TextMode="Time"></asp:TextBox>
                            </div>
                        </div> 
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">End Time<span class="required" aria-required="true"> *</span></label>
                                <asp:TextBox ID="txtEndTime" class="form-control req" runat="server" TextMode="Time"></asp:TextBox>
                            </div>
                        </div>  
                    </div>
                    <div class="row">
