<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeBehind="CRMCSMapping.aspx.cs" Inherits="SystemAdmin.ESS.CRMCSMapping" %>
                    ...
                    <div class="row"> 
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" oldname="" onchange="CheckName(this);" ID="ddlCEC" CssClass="form-control select2ddl req"></asp:DropDownList>
                            </div>
                        </div> 
                        <div class="col-md-3">
                            <div class="form-group">
    ...
    <script>
        function CheckName(args) {
            ...
            $.ajax({
                ...
                url: "CRMCSMapping.aspx/CheckName",
