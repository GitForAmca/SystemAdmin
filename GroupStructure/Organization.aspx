<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.master"  AutoEventWireup="true" CodeBehind="Organization.aspx.cs" Inherits="SystemAdmin.GroupStructure.Organization" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="portlet box green margin-top-10">
        <div class="portlet-title">
            <div class="caption">
                <asp:Label ID="lblPageListTitle" runat="server" Text="Organization"></asp:Label>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <asp:ListView ID="LV_Organization" runat="server" ItemPlaceholderID="itemplaceholder">
                        <LayoutTemplate>
