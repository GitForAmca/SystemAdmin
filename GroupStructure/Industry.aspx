<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MainMaster.master" CodeBehind="Industry.aspx.cs" Inherits="SystemAdmin.GroupStructure.Industry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="portlet box green margin-top-10">
        <div class="portlet-title">
            <div class="caption">
                <asp:Label ID="lblPageListTitle" runat="server" Text="Industry"></asp:Label>
            </div>
        </div>
        <div id="divView" runat="server" class="portlet-body form-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <asp:ListView ID="LV_Industry" runat="server" ItemPlaceholderID="itemplaceholder">
                        <LayoutTemplate>
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             <label class="control-label">Head of Industry<span class="required" aria-required="true"> *</span></label>
