<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeBehind="CSR.aspx.cs" Inherits="SystemAdmin.AutomaticDataAssign.CSR" %>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <asp:Label ID="lblPageListTitle" runat="server" Text="CSR"></asp:Label>
                </div>
            </div> 
                        ...
                        <asp:ListView ID="LV_CEC" runat="server" ItemPlaceholderID="itemplaceholder">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <span class='<%# bool.Parse( Eval("IsAssigned").ToString())==true?"label label-sm label-success":"label label-sm label-danger"%>' runat="server"><%# bool.Parse( Eval("IsAssigned").ToString())==true?"Yes":"No"%></span>
                                    </td>
                                    <td>
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Name<span class="required" aria-required="true"> *</span></label>
                                <asp:DropDownList runat="server" ID="ddlAddEmpCSR" CssClass="form-control req select2ddl"></asp:DropDownList>
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">CEM<span class="required" aria-required="true"> *</span></label>
                                <asp:DropDownList runat="server" ID="ddlCEM" CssClass="form-control req select2ddl"></asp:DropDownList>
                            </div>
                        </div> 
