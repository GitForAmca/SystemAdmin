...
{
    public partial class CEC : System.Web.UI.Page
    {
        ...
        void FillAddCEC(DropDownList ddl)
        {
            EssPL PL = new EssPL();
            PL.OpCode = 111;
        ...
        protected void lnkBtnAddNew_Click(object sender, EventArgs e)
        {
            ...
            BindCheckBoxList();
            FillAddCEC(ddlAddEmpCEC);
            ClearField();
            ddlAddEmpCEC.Enabled = true;
            ViewState["Mode"] = "Add";
        }
                ...
                if (chkSelect != null)
                {
                    if (chkSelect.Checked)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            ddlAddEmpCEC.Enabled = false;
                            ddlAddEmpCEC.SelectedIndex = ddlAddEmpCEC.Items.IndexOf(ddlAddEmpCEC.Items.FindByValue(dt.Rows[0]["EmpId"].ToString()));
                            if (PL.dt.Rows[0]["IsLeadAssign"].ToString() == "False")
                            {
        ...
        {
            string xml = "<tr>";
            xml += "<EmpId><![CDATA[" + ddlAddEmpCEC.SelectedValue + "]]></EmpId>";
            xml += "<DepartmentId><![CDATA[" + 41 + "]]></DepartmentId>";
            xml += "<Status><![CDATA[" + "Assign" + "]]></Status>";
            xml += "<IsLeadAssign><![CDATA[" + chkIsAssigned.Checked + "]]></IsLeadAssign>";
