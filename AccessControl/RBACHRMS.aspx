...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <asp:Panel runat="server" ID="PnlGroup" CssClass="dropdown-container">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <asp:CheckBox ID="chklstGroup" ForeColor="Blue" Font-Bold="true"
                                                runat="server" Text="Select All"
                                                AutoPostBack="true" OnCheckedChanged="chkSelectAllGroup_CheckedChangedGrp" />

                                            <div class="company-items-wrapper">
                                                <asp:CheckBoxList ID="LstGroup"
                                                    CssClass="lstGroup-checkboxlist reqb" AutoPostBack="true"
                                                    OnSelectedIndexChanged="LstGroup_SelectedIndexChanged"
                                                    runat="server" RepeatDirection="Vertical" />
                                            </div>
                                        </div>
                                    </asp:Panel>
                                ...
                                <div class="col-md-6">
                                    <asp:Panel runat="server" ID="PnlIndustry" CssClass="dropdown-container">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <asp:CheckBox ID="chklstIndustry" ForeColor="Blue" Font-Bold="true"
                                                runat="server" Text="Select All"
                                                AutoPostBack="true" OnCheckedChanged="chkSelectAllIndustry_CheckedChangedGrp" />

                                            <div class="company-items-wrapper">
                                                <asp:CheckBoxList ID="LstIndustry"
                                                    CssClass="lstIndustry-checkboxlist reqb" AutoPostBack="true"
                                                    OnSelectedIndexChanged="LstIndustry_SelectedIndexChanged"
                                                    runat="server" RepeatDirection="Vertical" />
                                            </div>
                                        </div>
                                    </asp:Panel>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <asp:Panel runat="server" ID="Panel1" CssClass="dropdown-container">
                                        <button type="button" class="dropdown-button">Choose an item</button>
                                        <div class="dropdown-menu">
                                            <input type="text" class="dropdown-search" placeholder="Search..." />

                                            <asp:CheckBox ID="chklstRegion" ForeColor="Blue" Font-Bold="true"
                                                runat="server" Text="Select All"
                                                AutoPostBack="true" OnCheckedChanged="chkSelectAllRegion_CheckedChangedOrg" />

                                            <div class="company-items-wrapper">
                                                <asp:CheckBoxList ID="LstRegion"
                                                    CssClass="lstRegion-checkboxlist reqb" AutoPostBack="true"
                                                    OnSelectedIndexChanged="LstRegion_SelectedIndexChanged"
                                                    runat="server" RepeatDirection="Vertical" />
                                            </div>
                                        </div>
                                    </asp:Panel>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <asp:Panel runat="server" ID="Panel2" CssClass="dropdown-container">
                                        <button type="button" class="dropdown-button">Choose an item</button>
                                        <div class="dropdown-menu">
                                            <input type="text" class="dropdown-search" placeholder="Search..." />

                                            <asp:CheckBox ID="chklstOrganization" ForeColor="Blue" Font-Bold="true"
                                                runat="server" Text="Select All"
                                                AutoPostBack="true" OnCheckedChanged="chkSelectAllOrg_CheckedChangedCompany" />

                                            <div class="company-items-wrapper">
                                                <asp:CheckBoxList ID="LstOrg"
                                                    CssClass="lstOrgnization-checkboxlist reqb" AutoPostBack="true"
                                                    OnSelectedIndexChanged="LstOrg_SelectedIndexChanged"
                                                    runat="server" RepeatDirection="Vertical" />
                                            </div>
                                        </div>
                                    </asp:Panel>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <asp:Panel runat="server" ID="Panel3" CssClass="dropdown-container">
                                        <button type="button" class="dropdown-button">Choose an item</button>
                                        <div class="dropdown-menu">
                                            <input type="text" class="dropdown-search" placeholder="Search..." />

                                            <asp:CheckBox ID="chklstCompany" ForeColor="Blue" Font-Bold="true"
                                                runat="server" Text="Select All"
                                                AutoPostBack="true" OnCheckedChanged="chkSelectAllCompany_CheckedChanged" />

                                            <div class="company-items-wrapper">
                                                <asp:CheckBoxList ID="LstCompany"
                                                    CssClass="lstCompany-checkboxlist reqb" AutoPostBack="true"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <asp:Panel runat="server" ID="Panel4" CssClass="dropdown-container">
                                        <button type="button" class="dropdown-button">Choose an item</button>
                                        <div class="dropdown-menu">
                                            <input type="text" class="dropdown-search" placeholder="Search..." />

                                            <asp:CheckBox ID="chkWorkLocation" ForeColor="Blue" Font-Bold="true"
                                                runat="server" Text="Select All"
                                                AutoPostBack="true" OnCheckedChanged="chkSelectAllLocation_CheckedChanged" />

                                            <div class="company-items-wrapper">
                                                <asp:CheckBoxList ID="LstWorkLocation"
                                                    CssClass="lstWorkLocation-checkboxlist reqb" AutoPostBack="true"
                                                    OnSelectedIndexChanged="LstLocation_SelectedIndexChanged"
                                                    runat="server" RepeatDirection="Vertical" />
                                            </div>
                                        </div>
                                    </asp:Panel>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <asp:Panel runat="server" ID="Panel5" CssClass="dropdown-container">
                                        <button type="button" class="dropdown-button">Choose an item</button>
                                        <div class="dropdown-menu">
                                            <input type="text" class="dropdown-search" placeholder="Search..." />

                                            <asp:CheckBox ID="chkReportingTo" ForeColor="Blue" Font-Bold="true"
                                                runat="server" Text="Select All"
                                                AutoPostBack="true" OnCheckedChanged="chkSelectAllReporting_CheckedChanged" />

                                            <div class="company-items-wrapper">
                                                <asp:CheckBoxList ID="LstReportingTo"
                                                    CssClass="lstReportingTo-checkboxlist reqb" AutoPostBack="true"
                                                    OnSelectedIndexChanged="LstAllReporting_SelectedIndexChanged"
                                                    runat="server" RepeatDirection="Vertical" />
                                            </div>
                                        </div>
                                    </asp:Panel>
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="btnaddbulkaccess" runat="server" class="btn blue"
                            OnClick="btnaddbulkaccess_Click"
                            OnClientClick="return CheckRequiredField('reqb');"
                            Text="Apply" />
    ...
    <script type="text/javascript">
        function selectAllRegion(source) {
            debugger
            var container = source.closest(".region-contai
            ner");
            if (!container) return;
...
function CheckRequiredField(cssClass) {
    ...
    // Validate each CheckBoxList group
    $('.' + cssClass).each(function () {

        // Count how many items are selected (checked)
        var selectedCount = $(this).find("input[type='checkbox']:checked").length;

        if (selectedCount === 0) {

            // Show validation message on the dropdown panel
            AddRequiredMessage($(this).closest('.dropdown-container')[0]);
    ...
    <script> 
        ...
        //$(document).on("change", ".lstGroup-checkboxlist input[type='checkbox']", function () {
        //    updateDropdownButtonText();
        //});


        $(document).on("change", "input[type='checkbox']", function () {
            if ($(this).closest(".lstGroup-checkboxlist").length > 0) {
                updateDropdownButtonText();
            }
            if ($(this).closest(".lstIndustry-checkboxlist").length > 0) {
                updateDropdownButtonText();
            }
            if ($(this).closest(".lstRegion-checkboxlist").length > 0) {
                updateDropdownButtonText();
            }
            if ($(this).closest(".lstOrgnization-checkboxlist").length > 0) {
                updateDropdownButtonText();
            }
            if ($(this).closest(".lstCompany-checkboxlist").length > 0) {
                updateDropdownButtonText();
            }
            if ($(this).closest(".lstWorkLocation-checkboxlist").length > 0) {
                updateDropdownButtonText();
            }
            if ($(this).closest(".lstReportingTo-checkboxlist").length > 0) {
                updateDropdownButtonText();
            }
        ...
        function updateDropdownButtonText() {
            $(".dropdown-container").each(function () {
                ...
                const selected1 = $checkboxLists.filter(":checked").map(function () {
                    var id = $(this).attr("id");
                ...
                else if ($dropdown.find(".lstGroup-checkboxlist").length) {
                    btn.text(selected1.length ? selected1.join(", ") : "Choose an item");
                }
                else if ($dropdown.find(".lstIndustry-checkboxlist").length) {
                    btn.text(selected1.length ? selected1.join(", ") : "Choose an item");
                }
                else if ($dropdown.find(".lstRegion-checkboxlist").length) {
                    btn.text(selected1.length ? selected1.join(", ") : "Choose an item");
                }
                else if ($dropdown.find(".lstOrgnization-checkboxlist").length) {
                    btn.text(selected1.length ? selected1.join(", ") : "Choose an item");
                }
                else if ($dropdown.find(".lstCompany-checkboxlist").length) {
                    btn.text(selected1.length ? selected1.join(", ") : "Choose an item");
                }
                else if ($dropdown.find(".lstWorkLocation-checkboxlist").length) {
                    btn.text(selected1.length ? selected1.join(", ") : "Choose an item");
                }
                else if ($dropdown.find(".lstReportingTo-checkboxlist").length) {
                    btn.text(selected1.length ? selected1.join(", ") : "Choose an item");
                }
            });
        }
      ...
      $(document).ready(function ()
{
    ...
    if (typeof (__doPostBack) !== "undefined") 
    {
      ...
      <%-- $("#<%= LstGroup.ClientID %>").on("change", function (e) {
          ...
          <%--  $(document).on("change", "#<%= LstGroup.ClientID %> input[type='checkbox']", function () {

                // Get selected values
                var selected = $("#<%= LstGroup.ClientID %> input[type='checkbox']:checked")
        ...
        <%--    $("#<%= LstIndustry.ClientID %>").on("change", function (e) {
          ...
          <%--  $(document).on("change", "#<%= LstIndustry.ClientID %> input[type='checkbox']", function () {

                // Get selected industries
                var selected = $("#<%= LstIndustry.ClientID %> input[type='checkbox']:checked")
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    success: function (response) {
                        populateIndustryRegion("#<%= LstRegion.ClientID %>", response.d);
                    }
                });
