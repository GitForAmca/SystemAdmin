<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeBehind="LicenseType.aspx.cs" Inherits="SystemAdmin.ESS.LicenseType" %>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <asp:Label ID="lblPageListTitle" runat="server" Text="License Type"></asp:Label>
                </div>
            </div> 
            ...
            <div id="divView" runat="server" class="portlet-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:ListView ID="LV_LicenseType" runat="server" ItemPlaceholderID="itemplaceholder">
                            <LayoutTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtType" CssClass="form-control reqRec" runat="server" placeholder="input here"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
