...
{
    public partial class RequestBox : System.Web.UI.Page
    {
        ...
        void BindDepartment(ListBox ddl)
        {
            EssPL PL = new EssPL();
            PL.OpCode = 59;
            EssDL.returnTable(PL);
        ...
        void BindMenu(DropDownList ddl)
        {
            EssPL PL = new EssPL();
            PL.OpCode = 60;
            EssDL.returnTable(PL);
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            if (txtRequestBox.Text != "")
            {
                ...
                string xml = "<tbl>";
                xml += "<tr>";
                xml += "<RequestBox><![CDATA[" + txtRequestBox.Text + "]]></RequestBox>";
                xml += "<Menu><![CDATA[" + ddlMenu.SelectedValue + "]]></Menu>";
                xml += "<Type><![CDATA[" + ddlType.SelectedValue + "]]></Type>";
                xml += "<Department><![CDATA[" + Request.Form[ddlDepartment.UniqueID] + "]]></Department>";
