...
{
    public partial class SalesCRMMapping : System.Web.UI.Page
    {
        ...
        void BAList()
        {
            ...
            ddlBA.DataValueField = "Autoid";
            ddlBA.DataTextField = "BA";
            ddlBA.DataSource = PL.dt;
            ddlBA.DataBind();
            ddlBA.Items.Insert(0, new ListItem("Select BA", ""));
        }
        void CECList()
        {
            DropdownPL PL = new DropdownPL();
