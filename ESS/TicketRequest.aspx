<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeBehind="TicketRequest.aspx.cs" Inherits="SystemAdmin.ESS.RequestBox" %>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <asp:Label ID="lblPageListTitle" runat="server" Text="Ticket Request"></asp:Label>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtRequestBox" CssClass="form-control reqRec" runat="server" placeholder="input here"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label class="control-label">Menu <span class="required" aria-required="true">*</span></label>
                            <asp:DropDownList ID="ddlMenu" class="form-control select2ddl reqRec" runat="server"></asp:DropDownList>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:ListBox ID="ddlDepartment" SelectionMode="Multiple" class="form-control reqRec multiselectddl" runat="server"></asp:ListBox>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
