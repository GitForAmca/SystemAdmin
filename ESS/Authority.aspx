<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeBehind="Authority.aspx.cs" Inherits="SystemAdmin.ESS.Authority " %>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <asp:Label ID="lblPageListTitle" runat="server" Text="Authority "></asp:Label>
                </div>
            </div> 
            ...
            <div id="divView" runat="server" class="portlet-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label">Authority<span class="required" aria-required="true"></span></label> 
                            <asp:DropDownList ID="ddlAuthorityFilter" runat="server" CssClass="form-control select2ddl"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label">Type<span class="required" aria-required="true"></span></label>
                            <asp:ListBox ID="lstLicenseTypeFilter" SelectionMode="Multiple" class="form-control select2ddl reqRec" runat="server"></asp:ListBox>  
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="form-group"> 
                            <label class="control-label">&nbsp;</label> 
                                <div class="btn-group pull-right">
                                    <button class="btn dropdown-toggle" data-toggle="dropdown">Action <i class="fa fa-angle-down"></i></button>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:ListView ID="LV_Authority" runat="server" ItemPlaceholderID="itemplaceholder">
                            <LayoutTemplate>
                ...
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Authority<span class="required" aria-required="true"> *</span></label>
                                <asp:TextBox ID="txtAuthority" CssClass="form-control reqRec" runat="server" placeholder="input here"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">License Type<span class="required" aria-required="true"> *</span></label>
                                <asp:ListBox ID="lstLicenseType" SelectionMode="Multiple" OnSelectedIndexChanged="lstLicenseType_SelectedIndexChanged" AutoPostBack="true" class="form-control select2ddl reqRec" runat="server"></asp:ListBox>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Sector<span class="required" aria-required="true"> *</span></label>
                                <asp:ListBox ID="lstSector" SelectionMode="Multiple" OnSelectedIndexChanged="lstSector_SelectedIndexChanged" AutoPostBack="true" class="form-control select2ddl reqRec" runat="server"></asp:ListBox>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
